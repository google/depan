 ...
 * {@link ViewDocument}'s edge display properties data structure,
 * and can be created from or inserted into that component.
 * 
 * @author <a href="leeca@pnambic.com">Lee Carver</a>
 */
public class EdgeDisplayDocument
  extends ModelAnalysisDocument<Map<GraphEdge, EdgeDisplayProperty>> {

  public EdgeDisplayDocument(
      String name, DependencyModel model,
      Map<GraphEdge, EdgeDisplayProperty> relationProperties) {
