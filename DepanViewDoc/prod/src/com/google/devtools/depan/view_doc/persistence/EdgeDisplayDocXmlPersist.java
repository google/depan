 ...
 */
public class EdgeDisplayDocXmlPersist
    extends AbstractDocXmlPersist<EdgeDisplayDocument> {

  private final static EdgeDisplayDocXStreamConfig DOC_CONFIG =
      new EdgeDisplayDocXStreamConfig();

  public EdgeDisplayDocXmlPersist(ObjectXmlPersist xmlPersist) {
    super(xmlPersist);
  }

  public static EdgeDisplayDocXmlPersist build(boolean readable) {
    ObjectXmlPersist persist = XStreamFactory.build(readable, DOC_CONFIG);
    return new EdgeDisplayDocXmlPersist(persist);
  }
