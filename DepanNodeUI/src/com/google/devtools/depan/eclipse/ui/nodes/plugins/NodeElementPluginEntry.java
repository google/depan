...
/**
 * A {@link NodeElementPluginEntry} represent an entry in a plugin.xml file,
 * describing a source plugin.
 *
 * @author Yohann Coppel
 *
 */
public class NodeElementPluginEntry {
   ...
   */
  private NodeElementPlugin instance = null;
   ...
   * @param element
   */
  public NodeElementPluginEntry(IConfigurationElement element) {
   ...
   */
  public NodeElementPlugin getInstance() throws CoreException {
    if (null == instance) {
      instance = (NodeElementPlugin) element.createExecutableExtension(ATTR_CLASS);
    }
    return instance;
  }
}
