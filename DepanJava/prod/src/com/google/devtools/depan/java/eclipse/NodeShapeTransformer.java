...
public class NodeShapeTransformer extends JavaElementDispatcher<GLEntity>
    implements ElementTransformer<GLEntity> {
  private static final NodeShapeTransformer instance =
      new NodeShapeTransformer();

  public static NodeShapeTransformer getInstance() {
    return instance;
  }
